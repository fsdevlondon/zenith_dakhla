    ...
    <div className="banner banner--90 banner-mobile--90" style={{height: '727.8px'}}>
      ...
      <div className="banner__image-wrap banner__image-desktop ">
        <div className="banner__image"
             style={{backgroundImage: "url('https://www.urbanicathehotels.com/wp-content/uploads/2018/10/Spherical-Urbanica-0534-e1539577593416.jpg')"}}/>
      </div>
              ...
              <div id="content-subnav__item-overview" className="content-subnav__item fadein-slideready fadein-slideup"
                ...
                <div className="content-layout content-layout--restaurant">
                  ...
                  <p>If you’re into delicious craft cocktails and good times then head to Minibar. The
                    #notyouraverageminibar is one of Miami’s hottest new bars. Minibar provides fresh, mid-century
                    lounge with a sexy, contemporary twist located in the quaint South of Fifth area located at Urbanica
                    The Meridian Hotel.</p>
                </div>
              </div>
                ...
                <div className="reserve-box">
                  <div className="reserve-box__imgbox">
                    <img className="img-desktop"
                         src="https://www.urbanicathehotels.com/wp-content/uploads/2018/10/Spherical-Urbanica-Hotels-Meridian-South-Beach_bar_01.jpg"
                         alt=""/>
              ...
              <div id="content-subnav__item-gallery-restaurant"
                ...
                <div className="category-gallery">
                  <div className="category-gallery__categorybox">
                    <div id="category-gallery__category-happy-hour"
                      ...
                      <div className="owl-stage-outer">
                        <div className="owl-stage"
                             style={{transform: 'translate3d(-2688px, 0px, 0px)', transition: 'all 0s ease 0s', width: '6720px'}}>
                          <div className="owl-item cloned" style={{width: '1344px'}}>
                            <div className="category-gallery__image">
                              <img
                                src="https://www.urbanicathehotels.com/wp-content/uploads/2018/08/Spherical-Urbanica-9739.jpg"
                                alt="spherical-urbanica-9739"/>
                    ...
                    <div id="category-gallery__category-late-night"
                    ...
                    <div id="category-gallery__category-bar-bites"
                         className="category-gallery__category  category-gallery-carousel-js owl-carousel owl-loaded owl-drag">
                      <div className="owl-stage-outer">
                        <div className="owl-stage"
                             style={{transform: 'translate3d(-2688px, 0px, 0px)', transition: 'all 0s ease 0s', width: '6720px'}}>
                          <div className="owl-item cloned" style={{width: '1344px'}}>
                            <div className="category-gallery__image">
                              <img src="https://www.urbanicathehotels.com/wp-content/uploads/2018/10/DSC_0095.jpeg"
                                   alt="dsc_0095"/>
                ...
                <div className="accordion">
                  <div className="accordion__item accordion__item--large">
                    <div className="accordion__title-container">
                      <span className="accordion__title">Cocktails </span><span className="accordion__symbol accordion__symbol--plus"/>
                    </div>
                  ...
                  <div className="accordion__item accordion__item--large">
                    <div className="accordion__title-container">
                      <span className="accordion__title">Beer</span><span className="accordion__symbol accordion__symbol--plus"/>
                    </div>
                    <div className="accordion__content">
                      <div className="accordion__menu">
                  ...
                  <div className="accordion__item accordion__item--large">
                    <div className="accordion__title-container">
                      <span className="accordion__title">Wine</span><span className="accordion__symbol accordion__symbol--plus"/>
                    </div>
                    <div className="accordion__content">
                      <div className="accordion__menu">
                  ...
                  <div className="accordion__item accordion__item--large">
                    <div className="accordion__title-container">
                      <span className="accordion__title">Food</span><span className="accordion__symbol accordion__symbol--plus"/>
                    </div>
                    <div className="accordion__content">
                      <div className="accordion__menu">
